...
public class DarkeLakes extends WorldGenerator
{
    private Block field_150556_a;
    private static final String __OBFID = "CL_00000418";

    public DarkeLakes(Block p_i45455_1_)
    {
        ...
        else
        {
            ...
            for (i1 = 0; i1 < 16; ++i1)
            {
                for (j2 = 0; j2 < 16; ++j2)
                {
                    for (j1 = 4; j1 < 8; ++j1)
                    {
                        if (aboolean[(i1 * 16 + j2) * 8 + j1] && par1World.getBlock(par3 + i1, par4 + j1 - 1, par5 + j2) == DarkeBlocks.darkedirt && par1World.getSavedLightValue(EnumSkyBlock.Sky, par3 + i1, par4 + j1, par5 + j2) > 0)
                        {
                            ...
                            {
                                par1World.setBlock(par3 + i1, par4 + j1 - 1, par5 + j2, DarkeBlocks.darkedirt, 0, 2);
                            }
                        }
                    }
                }
                ...
                for (i1 = 0; i1 < 16; ++i1)
                {
                    for (j2 = 0; j2 < 16; ++j2)
                    {
                        for (j1 = 0; j1 < 8; ++j1)
                        {
                            ...
                            {
                                par1World.setBlock(par3 + i1, par4 + j1, par5 + j2, DarkeBlocks.darkeStone, 0, 2);
                            }
                        }
                    }
                }
